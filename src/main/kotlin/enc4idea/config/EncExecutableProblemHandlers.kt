...
fun findGitExecutableProblemHandler(project: Project): EncExecutableProblemHandler {
  return when {
...
interface EncExecutableProblemHandler {
...
private class DefaultExecutableProblemHandler(val project: Project) : EncExecutableProblemHandler {
